...
<head>
  <meta charset="utf-8">
    ...
    <title>Schoole Management System Admin - Log in </title>
							...
							<form method="POST" action="{{ route('login') }}">
								...
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="email" id="email" class="form-control pl-15 bg-transparent text-white plc-white" name="email" :value="old('email')" placeholder="E-amil">
									</div>
								</div>
								<div class="form-group">
									<div class="input-group mb-3">
