    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview {{($prefix=='profiles')? 'active':''}}">
          <a href="#">
            <i class="fa-solid fa-circle-user"></i> <span>Manage Profile</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-right pull-right"></i>
            </span>
          </a>
        ...
        <li class="treeview {{($prefix=='setups')? 'active':''}}">
            <a href="#">
              <i class="fa-solid fa-circle-user"></i> <span>Setup Management</span>
              <span class="pull-right-container">
                <i class="fa fa-angle-right pull-right"></i>
              </span>
            </a>
          ...
          <li class="treeview {{($prefix=='students')? 'active':''}}">
            <a href="#">
              <i class="fa-solid fa-circle-user"></i> <span>Students Management</span>
              <span class="pull-right-container">
                <i class="fa fa-angle-right pull-right"></i>
              </span>
            </a>
            <ul class="treeview-menu">
              ...
              <li><a href="{{route('student.roll.generate.view')}}"><i class="ti-more"></i>Roll Generate</a></li>
          ...
          <li class="treeview {{($prefix=='employees')? 'active':''}}">
            <a href="#">
              <i class="fa-solid fa-circle-user"></i> <span>Employee Management</span>
              <span class="pull-right-container">
                <i class="fa fa-angle-right pull-right"></i>
              </span>
            </a>
