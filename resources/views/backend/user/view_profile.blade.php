    ...
    <div class="row">
        ...
        <div class="box">
            ...
            <div class="widget-user-header bg-black">
                <a style="float: right;" class="btn btn-primary mb-5" href="{{route('profile.edit')}}">Edit Profile</a>
            ...
            <div class="widget-user-image">
                ...
                {{-- @else
                @if ($user->image)
                <img class="rounded-circle" src="{{asset('upload/user_images')}}/{{$user->image}}" alt="User Avatar">
                @else
